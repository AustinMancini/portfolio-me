"""updating profile to see if alembic overwrites the key

Revision ID: 0b7d2bc1c1b7
Revises: 6daea96b83a6
Create Date: 2025-02-26 11:53:48.981546
...
revision: str = '0b7d2bc1c1b7'
down_revision: Union[str, None] = '6daea96b83a6'
...
def upgrade() -> None:
    ...
    op.add_column('profiles', sa.Column('age', sa.String(), nullable=True))
